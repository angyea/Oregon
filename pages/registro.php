...
$sql="select * from `usuarios` where dni='$ci'";
...
$sql = "INSERT INTO `usuarios` (`dni`, `nombre`, `apellido`, `correo`, `fechai`, `telefono`, `direccion`) VALUES ('$ci', '$nombre', '$apellido', '$correo', '$fechai', '$telefono', '$direccion')";
                                ...
                                <form role="form"  name="fe" action="?mod=registro&nuevo=nuevo" method="post">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input onkeydown="return enteros(this, event)" required type="text" name="ci" class="form-control" value="<?php echo $var1 ?>" id="exampleInputEmail1" placeholder="Nº de dni">
                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        $consulta="SELECT dni, nombre, apellido, correo,id_usuarios FROM usuarios ORDER BY dni ASC ";
...
";
     ...
     $consulta="SELECT dni, nombre, apellido, correo,telefono,direccion FROM usuarios where id_usuarios='$x1'";
     $bd->consulta($consulta);
     while ($fila=$bd->mostrar_registros()) {
        ...
        ?>
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <label for="exampleInputFile">Dni</label>
                                            <input onkeydown="return enteros(this, event)" required type="text" name="ci" class="form-control" value="<?php echo $fila[dni] ?>" id="exampleInputEmail1" placeholder="Cedula">
                                            <label for="exampleInputFile">telefono</label>
...
";
     ...
     $consulta="SELECT dni, nombre, apellido, correo FROM usuarios where id_usuarios='$x1'";
     $bd->consulta($consulta);
     while ($fila=$bd->mostrar_registros()) {
