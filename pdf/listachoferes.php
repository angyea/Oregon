...
class MiPDF extends FPDF {
	...
	$cabeceraT = array("Codigo ");
		...
		$mipdf -> Ln (2);
		$mipdf -> Cell(200,10,"Lista De Choferes $fecha",0,0,'C');
		$mipdf -> Ln (10);
		...
		for ($i = 0; $i < count($cabeceraT); $i++)
		{
			...
			$mipdf -> SetFont('ARIAL','B', 9);
$mipdf -> SetFillColor(0, 191, 255);
	$mipdf -> Cell(35,11,"Dni",1,0,'C',true);
	$mipdf -> SetFont('ARIAL','B', 9);
$mipdf -> SetFillColor(0, 191, 255);
...
$mipdf -> SetFillColor(0, 191, 255);
	$mipdf -> Cell(30,11,"Apellido",1,0,'C',true);
		...
		$mipdf -> SetFont('ARIAL','B', 9);
$mipdf -> SetFillColor(0, 191, 255);
	$mipdf -> Cell(25,11,"Categoria",1,0,'C',true);

	$mipdf -> SetFont('ARIAL','B', 9);
$mipdf -> SetFillColor(0, 191, 255);
	$mipdf -> Cell(25,11,"Nº Licencia",1,0,'C',true);
